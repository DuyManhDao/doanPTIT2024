...
import com.ptit.d20cntt.datn.fileupload.FileUpload;
...
public class SanPhamController {
    ...
    private final AnhBiaService anhSanPhamService;
    ...
    public String getViewAdd(Model model) {
        ...
        model.addAttribute("listnhacungcap", nhaCungCapService.getList());
