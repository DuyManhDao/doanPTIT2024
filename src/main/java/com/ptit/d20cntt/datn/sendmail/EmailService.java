package com.ptit.d20cntt.datn.sendmail;
...
public class EmailService {
	...
	public void sendNewAccountNVEmail(String recipientEmail, String email, String matKhau) {
		...
		message.setSubject("Chào Mừng: Thư xác nhận nhân viên của HMStore");
		message.setText("Chào " + recipientEmail + " ,\n\n" +
				"Bạn vừa dùng mail này để đăng kí tài khoản HMStore,\n\n" +
				"Tài khoản mới với tên đăng nhập : " + email + " ,\n\n" +
				"Mật Khẩu đăng nhập : " + matKhau + " ,\n\n" +
				"Một lần nữa chúc mừng bạn là thành viên của HMStore : http://localhost:8080/hmstore/trang-chu  ,\n\n" +
	...
	public void sendNewAccountKHEmail(String recipientEmail, String email, String matkhau) {
		...
		message.setText("Chào '" + recipientEmail + "' ,\n\n" +
				...
				"Tài khoản mới với tên đăng nhập : " + email + " ,\n\n" +
				"Mật Khẩu đăng nhập : " + matkhau + " ,\n\n" +
				"Cùng đăng nhập để trải nhiệm nhiều tiện ích tuyệt vời nhé :  http://localhost:8080/hmstore/trang-chu  ,\n\n" +
				" * Quý khách vui lòng không trả lời email này * ,\n\n" +
				"Trân trọng,\n[HMStore]");
	...
	public void sendEmail1(KhachHang khachHang, HoaDon hoaDon) {
		...
		StringBuilder content = new StringBuilder("<div style=\"font-family: 'Arial', sans-serif; font-size: 16px; color: black;\">")
				...
				.append("<p style=\"color: black;\">Cảm ơn bạn đã tin tưởng và mua hàng tại HMStore.</p>");
		...
		if (hoaDon.getTrangThai() == TrangThaiDonHang.DANG_CHUAN_BI) {
			content.append("<p style=\"color: black;\">Chúng tôi xin thông báo rằng đơn hàng của bạn hiện đang trong quá trình chuẩn bị và sẽ sớm được gửi đến địa chỉ của bạn.</p>")
					.append("<p style=\"color: black;\">Quý khách có thể tra cứu thông tin đơn hàng tại đây: http://localhost:8080/hmstore/tra-cuu-don-hang</p>");
		...
		if (hoaDon.getTrangThai() != TrangThaiDonHang.DA_HUY) {
			...
			content.append("<table border=\"1\" style=\"border-collapse: collapse;\">")
					...
					.append("<th style=\"border: 1px solid black;\">Loại vải</th>")
			...
			for (GioHangChiTiet gioHangChiTiet : gioHangChiTiets) {
				content.append("<tr>")
						...
						.append("<td style=\"border: 1px solid black;color: black;\">").append(gioHangChiTiet.getChiTietSanPham().getLoaiVai().getTen()).append("</td>")
			...
			content.append("<br>\n" +
					"<p style=\"color: black;\" class=\"email-content\">\n" +
					"Cảm ơn bạn đã chọn HMStore! Nếu có bất kỳ thắc mắc nào hoặc cần hỗ trợ, hãy liên hệ với chúng tôi qua số :0398194211.\n" +
					"</p>" +
					"</div>"
			);
		}
	...
	public void sendPasswordEmail(String recipientEmail, String newPassword) {
		...
		message.setText("Chào " + recipientEmail + " ,\n\n" +
				"Bạn vừa dùng mail này để xác nhận quên mật khẩu tài khoản HMStore,\n\n" +
				"Mật Khẩu đăng nhập mới của bạn là : " + newPassword + " ,\n\n" +
				"Nếu bạn không xác nhận quên mật khẩu mà vẫn nhận được mail này thì hãy liên hệ lại với HMStore ngay lập tức qua hotline :0398194211   ,\n\n" +
				"Trân trọng,\n[HMStore]");
