...
import com.ptit.d20cntt.datn.custom.ChiTietSanPhamCustom;
...
public interface ChiTietSanPhamRepository extends JpaRepository<ChiTietSanPham, Long> {
	...
	@Query(value = "select chi_tiet_san_pham.id_san_pham, chi_tiet_san_pham.id_loai_vai, chi_tiet_san_pham.id_mau_sac,\n" +
			" chi_tiet_san_pham.id_kich_thuoc,chi_tiet_san_pham.so_luong_ton,\n" +
